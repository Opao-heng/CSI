...
- [GAN/model.py](file://GAN/model.py)
- [GAN/loss.py](file://GAN/loss.py)
...
**Section sources**
- [GAN/train.py](file://GAN/train.py#L12-L37)
...
**Diagram sources**
- [GAN/train.py](file://GAN/train.py#L202-L282)

**Section sources**
- [GAN/train.py](file://GAN/train.py#L202-L282)
- [GAN/model.py](file://GAN/model.py#L169-L173)
...
**Section sources**
- [GAN/train.py](file://GAN/train.py#L111-L159)
...
*   同样地，将生成的标签与原始标签拼接。
*   将合并后的数据和标签分别保存为 `target_data.pt` 和 `target_labels.pt` 文件。这种数据增强策略有效增加了目标域的样本多样性，有助于提升下游任务（如分类）的模型泛化能力。

**Section sources**
- [GAN/train.py](file://GAN/train.py#L162-L199)
