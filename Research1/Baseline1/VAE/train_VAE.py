...
from Research1.Baseline1.VAE.model_VAE import build_model
from Research1.DataProcess.dataloder_GAN import CustomDataset, select_samples_by_label
from Research1.Baseline1.VAE.loss_VAE import vae_loss, frequency_consistency_loss, mmd_loss
...
if __name__ == "__main__":
    ...
    print(f"\n评估指标已保存到 VAE/vae_evaluation_results.json")
    print("=" * 70)
