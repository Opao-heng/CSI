...
from Research1.Baseline1.DCGAN.model_DCGAN import build_model
from Research1.DataProcess.dataloder_GAN import CustomDataset, select_samples_by_label
from Research1.Baseline1.DCGAN.loss_DCGAN import (
...
if __name__ == "__main__":
    ...
    print(f"\n评估指标已保存到 DCGAN/dcgan_evaluation_results.json")
    print("=" * 70)
