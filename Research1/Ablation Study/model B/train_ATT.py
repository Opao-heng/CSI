...
from Research1.DataProcess.dataloder_GAN import CustomDataset
...
def save_training_results(src_accuracy, tgt_accuracy, save_dir='model_F'):
    """
...
if __name__ == "__main__":
    ...
    best_model_path = "model_F/best_attention_model.pth"
    patience = 15
    ...
    # 保存训练结果
    save_training_results(best_src_accuracy, best_tgt_accuracy, save_dir='model_F')
