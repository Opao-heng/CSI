...
def save_training_history(train_losses, val_accuracies, loss_components_history, test_results_history, save_dir='R_CAL'):
    """
    保存训练历史数据到JSON文件
    """
    import json
...
if __name__ == "__main__":
    ...
    best_accuracy = 0.0
    best_model_path = "R_CAL/best_attention_model.pth"
    patience = 15  # 增加早停耐心值
    ...
    # 保存训练历史
    save_training_history(train_losses, val_accuracies, loss_components_history, test_results_history, save_dir='R_CAL')
